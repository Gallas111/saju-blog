      ...
      <main className="max-w-3xl mx-auto px-4 py-12 flex-1">
        ...
        <div className="prose text-foreground space-y-8 leading-relaxed">
          <section>
            ...
            <p>
              개인 점술사가 운영하는 미디어가 아니라, 고전 명리학 문헌을
              근거 자료로 삼아 콘텐츠 에디터가 작성·정리하는 편집 매체입니다.
            </p>
          </section>
          ...
          <section>
            ...
            <ul>
              <li>
                <strong>고전 문헌 참고</strong> — 자평진전·적천수·궁통보감
                같은 고전 명리학 텍스트를 콘텐츠의 근거 자료로 삼습니다.
              </li>
              <li>
          ...
          <section>
            ...
            <ol>
              ...
              <li>
                <strong>교차 확인</strong> — 고전 문헌과 현대 해석 자료를
                대조해 용어·이론의 일관성을 확인.
              </li>
              <li>
